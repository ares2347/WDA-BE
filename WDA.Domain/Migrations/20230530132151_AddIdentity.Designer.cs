...
namespace WDA.Domain.Migrations
{
    ...
    [Migration("20230530132151_AddIdentity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WDA.Domain.User.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("WDA.Domain.User.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("WDA.Domain.User.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("WDA.Domain.User.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WDA.Domain.User.Role", b =>
                {
                    b.HasOne("WDA.Domain.User.User", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById");

                    b.HasOne("WDA.Domain.User.User", "ModifiedBy")
                        .WithMany()
